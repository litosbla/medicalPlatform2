...
const obtenerRiesgoMasComun = (dataContador:any) => {
    // Encontrar el elemento con el mayor número de personas
    return dataContador.reduce((maxRiesgo:any, riesgoActual:any) => {
      if (!maxRiesgo || riesgoActual.personas > maxRiesgo.personas) {
        return riesgoActual;
      }
      return maxRiesgo;
    }, null);
